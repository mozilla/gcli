...
var Highlighter = require('gcli/host').Highlighter;
...
NodeType.prototype.onEnter = onEnter;
NodeType.prototype.onLeave = onLeave;
NodeType.prototype.onChange = onChange;
  ...
  try {
    if (arg.text === '') {
      ...
      if (nodes.length === 0) {
        ...
        reply = new Conversion(undefined, arg, Status.ERROR, message);
      }
...
NodeListType.prototype.onEnter = onEnter;
NodeListType.prototype.onLeave = onLeave;
NodeListType.prototype.onChange = onChange;
